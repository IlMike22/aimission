...
data class Goal(
        ...
        var repeatCount: Int = 0, // defines if an item has more than one part-steps/goals
        @ColumnInfo(name = "part_goals_achieved")
        var partGoalsAchieved: Int = 0, // a goal which has to be achieved several times in a month
